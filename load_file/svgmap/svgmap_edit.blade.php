                                    ...
                                    @foreach(config('language') as $k=>$g)
                                        <div class="layui-tab-item @if($k==1) layui-show @endif">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-4">
                                                    <input type="text" @if($k==1) name="map_name" @else name="map_name_{{$g['dir']}}" @endif value="@if(!empty($map['map_name_json'])){{json_decode($map['map_name_json'],true)[$k]}}@endif" class="form-control" @if($k==1) maxlength="20" @else maxlength="255" @endif />
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach

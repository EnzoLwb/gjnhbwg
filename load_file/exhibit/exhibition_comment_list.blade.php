            ...
            <div class="col-sm-12">
                <div class="tabs-container">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="{{route('admin.data.exhibition.exhibition_comment_list')}}">展览评论审核</a></li>
                    </ul>
                    <form role="form" id="form_submit" class="form-inline form-screen" method="get">
                        ...
                        &nbsp;&nbsp;
                        <div class="form-group">
                            <input type="text" name="exhibition_name" placeholder="展览名称" class="form-control" value="{{request('exhibition_name')}}" style="width: 200px;" maxlength="20">
                        </div>
                            ...
                            <tr class="gradeA">
                                ...
                                <td>
                                    @if(request('is_check')==1||empty(request('is_check')))
                                        <a class="ajaxBtn" href="javascript:void(0);" uri="{{route('admin.data.exhibition.pass_check',[1, $v['id']])}}" msg="是否要通过审核？"><i class="fa fa-check" title="通过"></i></a>
                                        <a class="ajaxBtn" href="javascript:void(0);" uri="{{route('admin.data.exhibition.unpass_check',[1, $v['id']])}}" msg="是否要不通过审核？"><i class="fa fa-ban" title="不通过"></i></a>
                                    @endif
                                    <a class="ajaxBtn" href="javascript:void(0);" uri="{{route('admin.data.exhibition.del_check',[1, $v['id']])}}" msg="是否删除？"><i class="fa fa-trash" title="删除"></i></a>
                                </td>
                            </tr>
                        @endforeach
                    </table>

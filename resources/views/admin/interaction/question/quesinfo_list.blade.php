    ...
    <div class="itra-wrap">
        <div class="itra-list">
            <div class="survey_pages_tab hidden_nav">
                ...
                <a class="pages_more" style="text-decoration: none;border: 2px solid #5084CD;width: 30px;height: 30px;text-align: center;font-size: 33px;color: #5084CD;line-height: 24px;padding-right: 2px;" href="javascript:;">+</a>
...
//            }
            ...
            if(data['infolist'][i-1]['type']==1){
                ...
                ajax_page=ajax_page+'<div><label class="ques_title">题目标题:</label><input type="text" value="'+data['infolist'][i-1]["question"]+'" name="r_question'+i+'"></div>';
                ...
                for(var a=1;a<=option_count;a++){
                    if(data['infolist'][i-1]['option_info'][a-1]['option_type']==1){
                        //普通选项
                        ajax_page=ajax_page+'<div class="option option_normal"><label class="answer_title">选项'+a+':</label><input type="text" name="r_question'+i+'option[]" value="'+data['infolist'][i-1]['option_info'][a-1]['option_info']+'">';
                        ...
                        //文本编辑选项
                        ajax_page=ajax_page+'<div class="option option_wenben"><label class="answer_title">选项'+a+':</label><input type="text" readonly name="r_question'+i+'option[]" value="'+data['infolist'][i-1]['option_info'][a-1]['option_info']+'"><i class="fa fa-remove del-wenben" _id="'+i+'" title="删除此项"></i></div>';
                    }
                }
                ...
                ajax_page=ajax_page+'<div><label class="ques_title">题目标题:</label><input type="text" value="" name="r_question'+i+'"></div>';
                ajax_page=ajax_page+'<div class="option option_normal"><label class="answer_title">选项'+1+':</label><input type="text" name="r_question'+i+'option[]" value=""></div>';
                ajax_page=ajax_page+'<div class="option option_normal"><label class="answer_title">选项'+2+':</label><input type="text" name="r_question'+i+'option[]" value=""></div>';
                ajax_page += '<div class="ques_btn_action">';
                ajax_page += '<a href="javascript:;" class="ques_btn add_input" _id="'+i+'">新增选项</a>';
                ajax_page += '<a href="javascript:;" class="ques_btn add_qita" _id="'+i+'">新增其他选项</a>';
                ajax_page += '<a href="javascript:;" class="ques_btn add_bumanyi" _id="'+i+'">新增不满意选项</a>';
            ...
            if(data['infolist'][i-1]['type']==2){
                ...
                ajax_page=ajax_page+'<div><label class="ques_title">题目标题:</label><input type="text" value="'+data['infolist'][i-1]["question"]+'" name="c_question'+i+'"></div>';
                var option_count=data['infolist'][i-1]['option_count'];
                for(var a=1;a<=option_count;a++){
                    if(data['infolist'][i-1]['option_info'][a-1]['option_type']==1){
                        //普通选项
                        ajax_page=ajax_page+'<div class="option option_normal"><label class="answer_title">选项'+a+':</label><input type="text" name="c_question'+i+'option[]" value="'+data['infolist'][i-1]['option_info'][a-1]['option_info']+'">';
                        if(a >= 3){
                            ajax_page += '<i class="fa fa-remove del-normal" _id="'+i+'" title="删除此项"></i>';
                            ajax_page += '</div>';
                        }else{
                        ...
                        //文本编辑选项
                        ajax_page=ajax_page+'<div class="option option_wenben"><label class="answer_title">选项'+a+':</label><input type="text" readonly name="c_question'+i+'option[]" value="'+data['infolist'][i-1]['option_info'][a-1]['option_info']+'"><i class="fa fa-remove del-wenben" _id="'+i+'" title="删除此项"></i></div>';
                    }
                }
                ajax_page += '<div class="ques_btn_action">';
                ajax_page += '<a href="javascript:;" class="ques_btn add_input" _id="'+i+'">新增选项</a>';
                ...
                ajax_page=ajax_page+'<div><label class="ques_title">题目标题:</label><input type="text" value="" name="c_question'+i+'"></div>';
                ajax_page=ajax_page+'<div class="option option_normal"><label class="answer_title">选项'+1+':</label><input type="text" name="c_question'+i+'option[]" value=""></div>';
                ajax_page=ajax_page+'<div class="option option_normal"><label class="answer_title">选项'+2+':</label><input type="text" name="c_question'+i+'option[]" value=""></div>';
        ...
        ajax_page=ajax_page+'<div class="page" id="p-end" style="display: none;text-align: center;"><h1 style="position: relative;margin-bottom:80px;"><i class="fa fa-hourglass-end" title="问卷结束" style="color: #5084CD;margin-right: 10px;font-size: 120px;"></i></h1><p style="font-size: 26px;">问卷到此结束，感谢您的参与！</p></div>';
    ...
    function initFunction(){
        $('.add_input').click(function(e){
            ...
            if($('#p-'+ ques_id + ' .show').hasClass('danxuan')){
                lastNormal.after('<div class="option option_normal"><label class="answer_title">选项'+(normalIndex + 1)+':</label><input type="text" name="r_question'+ques_id+'option[]" value=""><i class="fa fa-remove del-mormal" _id="'+ques_id+'" title="删除此项"></i></div>');
            }else{
                lastNormal.after('<div class="option option_normal"><label class="answer_title">选项'+(normalIndex + 1)+':</label><input type="text" name="c_question'+ques_id+'option[]" value=""><i class="fa fa-remove del-mormal" _id="'+ques_id+'" title="删除此项"></i></div>');
            }
        ...
        $('.add_qita').click(function(e){
            ...
            var lastNormal = $($(rightDiv).find('.option')[normalIndex - 1]);
            if($('#p-'+ ques_id + ' .show').hasClass('danxuan')){
                lastNormal.after('<div class="option option_wenben"><label class="answer_title">选项'+(normalIndex + 1)+':</label><input type="text" readonly name="r_question'+ques_id+'option[]" value="其他____________"><i class="fa fa-remove del-wenben" _id="'+ques_id+'" title="删除此项"></i></div>');
            }else{
                lastNormal.after('<div class="option option_wenben"><label class="answer_title">选项'+(normalIndex + 1)+':</label><input type="text" readonly name="c_question'+ques_id+'option[]" value="其他____________"><i class="fa fa-remove del-wenben" _id="'+ques_id+'" title="删除此项"></i></div>');
            }
        ...
        $('.add_bumanyi').click(function(e){
            ...
            var lastNormal = $($(rightDiv).find('.option')[normalIndex - 1]);
            if($('#p-'+ ques_id + ' .show').hasClass('danxuan')){
                lastNormal.after('<div class="option option_wenben"><label class="answer_title">选项'+(normalIndex + 1)+':</label><input type="text" readonly name="r_question'+ques_id+'option[]" value="不满意(请注明原因)____________"><i class="fa fa-remove del-wenben" _id="'+ques_id+'" title="删除此项"></i></div>');
            }else{
                lastNormal.after('<div class="option option_wenben"><label class="answer_title">选项'+(normalIndex + 1)+':</label><input type="text" readonly name="c_question'+ques_id+'option[]" value="不满意(请注明原因)____________"><i class="fa fa-remove del-wenben" _id="'+ques_id+'" title="删除此项"></i></div>');
            }

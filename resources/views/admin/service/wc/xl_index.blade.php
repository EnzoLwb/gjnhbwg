            ...
            <div class="col-sm-12">
                <div class="tabs-container">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="{{route('admin.service.wenchuangxl')}}">系列列表</a></li>
                        <li><a href="{{route('admin.service.wenchuangxl.add')}}">添加系列</a></li>
                    </ul>
                    ...
                    <ul class="exhibition-list">
                        ...
                        <li>
                            <div class="list-pic">
                                ...
                                <a class="btn-edit" href="{{route('admin.service.wenchuangxl.edit', $g['id'])}}">编辑</a>
                                <a class="ajaxBtn btn-delete" href="javascript:void(0);" uri="{{route('admin.service.wenchuangxl.delete',$g['id'])}}" msg="是否删除该系列及系列下的产品？">删除</a>

                                @if($g['is_show']==1)
                                    <a class="ajaxBtn btn-set" href="javascript:void(0);" uri="{{route('admin.service.wenchuangxl.unset_show',$g['id'])}}" msg="是否取消显示？">取消显示</a>
                                @else
                                    <a class="ajaxBtn btn-set" href="javascript:void(0);" uri="{{route('admin.service.wenchuangxl.set_show' ,$g['id'])}}" msg="是否设为显示？">设置显示</a>
                                @endif
                            </div>

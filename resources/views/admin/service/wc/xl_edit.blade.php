            ...
            <div class="col-sm-12">
                <div class="tabs-container">
                    <ul class="nav nav-tabs">
                        <li><a href="{{route('admin.service.wenchuangxl')}}">系列列表</a></li>
                        @if(isset($data))
                        <li class="active"><a href="{{route('admin.service.wenchuangxl.edit',$id)}}">编辑系列</a></li>
                        @else
                        <li class="active"><a href="{{route('admin.service.wenchuangxl.add')}}">添加系列</a></li>
                        @endif
                    </ul>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <form action="{{route('admin.service.wenchuangxl.save')}}" method="post" class="form-horizontal ajaxForm">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10" id="t_extfile_box">
                                <div id="t_extfile_picker">选择图片</div>
                                @if(isset($data))
                                    <div class="img-div">
                                        <img src="{{$data['img_1']}}" val="{{$data['img_1']}}"/>
                                        <span class="cancel">×</span>
                                    </div>
                                @endif
                            </div>

                            <input type="hidden" id="t_extfile" name="img_1" value="{{$data['img_1'] or ''}}"/>
                            <input type="hidden" id="t_extfile_file_id" name="extfile_file_id" value=""/>
                        </div>

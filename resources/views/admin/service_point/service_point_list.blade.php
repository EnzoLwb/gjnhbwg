                        ...
                        @foreach($info as $g)
                            <tr class="gradeA">
                                ...
                                <td>
                                    ...
                                    <a class="ajaxBtn" href="javascript:void(0);" uri="{{route('admin.servicepoint.service_point_delete' ,[$g['id']])}}?img_path={{$g['img']}}" title="删除" msg="是否删除该设施？"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                        @endforeach
                    </table>
